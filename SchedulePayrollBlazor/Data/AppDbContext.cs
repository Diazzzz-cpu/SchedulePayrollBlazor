    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      .HasColumnName("created_at");
        ...
        modelBuilder.Entity<PayrollLine>(entity =>
        {
            ...
            entity.Property(pl => pl.PayrollRunId).HasColumnName("payroll_run_id");
            entity.Property(pl => pl.PayrollEntryId).HasColumnName("payroll_entry_id").IsRequired();
            entity.Property(pl => pl.PayComponentId).HasColumnName("pay_component_id");
            entity.Property(pl => pl.Code).HasColumnName("code").HasMaxLength(50).IsRequired();
            entity.Property(pl => pl.Description).HasColumnName("description").HasMaxLength(250).IsRequired();
            entity.Property(pl => pl.Kind).HasColumnName("kind").HasMaxLength(50).IsRequired();
            ...
            entity.Property(pl => pl.IsAutoGenerated).HasColumnName("is_auto_generated").IsRequired();

            entity.HasOne(pl => pl.PayrollRun)
                  .WithMany(pr => pr.PayrollLines)
                  .HasForeignKey(pl => pl.PayrollRunId);

            entity.HasOne(pl => pl.PayrollEntry)
                  .WithMany(pe => pe.PayrollLines)
                  .HasForeignKey(pl => pl.PayrollEntryId)
                  .OnDelete(DeleteBehavior.Cascade);
